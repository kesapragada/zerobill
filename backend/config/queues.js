...
// Create the new dead-letter queue
const deadLetterQueue = new Queue(QUEUE_NAMES.DEAD_LETTER, { connection: redisConnection });
...
module.exports = {
  ...
  deadLetterQueue, // Export the new queue
};